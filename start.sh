...
echo -e "${YELLOW}║${NC}  ${BOLD}📍 访问地址${NC}                                       ${YELLOW}║${NC}"
...
echo -e "${YELLOW}║${NC}  ┌──────────┬──────────┬──────────┬────────────┐   ${YELLOW}║${NC}"
echo -e "${YELLOW}║${NC}  │ ${BOLD}角色${NC}     │ ${BOLD}用户名${NC}   │ ${BOLD}密码${NC}     │ ${BOLD}姓名${NC}       │   ${YELLOW}║${NC}"
echo -e "${YELLOW}║${NC}  ├──────────┼──────────┼──────────┼────────────┤   ${YELLOW}║${NC}"
echo -e "${YELLOW}║${NC}  │ ${RED}管理员${NC}   │ admin    │ admin123 │ 系统管理员 │   ${YELLOW}║${NC}"
echo -e "${YELLOW}║${NC}  ├──────────┼──────────┼──────────┼────────────┤   ${YELLOW}║${NC}"
echo -e "${YELLOW}║${NC}  │ ${GREEN}普通用户${NC} │ zhangwei │ 123456   │ 张伟       │   ${YELLOW}║${NC}"
echo -e "${YELLOW}║${NC}  ├──────────┼──────────┼──────────┼────────────┤   ${YELLOW}║${NC}"
echo -e "${YELLOW}║${NC}  │ ${GREEN}普通用户${NC} │ lina     │ 123456   │ 李娜       │   ${YELLOW}║${NC}"
echo -e "${YELLOW}║${NC}  ├──────────┼──────────┼──────────┼────────────┤   ${YELLOW}║${NC}"
echo -e "${YELLOW}║${NC}  │ ${GREEN}普通用户${NC} │ wangfang │ 123456   │ 王芳       │   ${YELLOW}║${NC}"
echo -e "${YELLOW}║${NC}  ├──────────┼──────────┼──────────┼────────────┤   ${YELLOW}║${NC}"
echo -e "${YELLOW}║${NC}  │ ${GREEN}普通用户${NC} │ liuyang  │ 123456   │ 刘洋       │   ${YELLOW}║${NC}"
echo -e "${YELLOW}║${NC}  └──────────┴──────────┴──────────┴────────────┘   ${YELLOW}║${NC}"
echo -e "${YELLOW}║${NC}                                                    ${YELLOW}║${NC}"
echo -e "${YELLOW}╚════════════════════════════════════════════════════╝${NC}"
echo ""
